...
class Test2(BaseAgent):
    ...
    def __init__(self, agent_id=None, name=None, description=None, similarity_threshold=0.7, **kwargs):
        ...
        name = name or "Test2 Agent"
        description = description or "test2"
    ...
    def process_message(self, message) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Error in Test2 Agent processing: {e}")
            return {
                "agent": self.name,
                "error": str(e),
